...
public:
  ...
  virtual bool issue(DownloadEngine* e) override;
  virtual void stop(DownloadEngine* e) override;
  virtual bool
  processResponse(const std::shared_ptr<BtAnnounce>& btAnnounce) override;
