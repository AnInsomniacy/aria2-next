...
public:
   ...
   * this download. This value is useful to track auto generated
   * downloads. If there is no such
   ...
   * of another download. If this download has no parent, the invalid GID is
   * returned (``isNull(gid)`` is true).
   */
