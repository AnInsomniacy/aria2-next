...
constexpr uint8_t OP_GLOBCALLBACKREQ = 0x9c;
constexpr uint8_t OP_INVALID_LOWID = 0x9e;
constexpr uint32_t SRV_TCPFLG_COMPRESSION = 0x00000001;
constexpr uint32_t SRV_TCPFLG_NEWTAGS = 0x00000008;
constexpr uint32_t SRV_TCPFLG_UNICODE = 0x00000010;
constexpr uint32_t SRV_TCPFLG_RELATEDSEARCH = 0x00000040;
constexpr uint32_t SRV_TCPFLG_TYPETAGINTEGER = 0x00000080;
constexpr uint32_t SRV_TCPFLG_LARGEFILES = 0x00000100;
constexpr uint32_t SRV_TCPFLG_TCPOBFUSCATION = 0x00000400;
constexpr uint32_t SRV_UDPFLG_EXT_GETSOURCES = 0x00000001;
constexpr uint32_t SRV_UDPFLG_EXT_GETFILES = 0x00000002;
constexpr uint32_t SRV_UDPFLG_NEWTAGS = 0x00000008;
constexpr uint32_t SRV_UDPFLG_UNICODE = 0x00000010;
constexpr uint32_t SRV_UDPFLG_EXT_GETSOURCES2 = 0x00000020;
constexpr uint32_t SRV_UDPFLG_LARGEFILES = 0x00000100;
constexpr uint32_t SRV_UDPFLG_UDPOBFUSCATION = 0x00000200;
constexpr uint32_t SRV_UDPFLG_TCPOBFUSCATION = 0x00000400;
...
constexpr uint8_t OP_MULTIPACKET = 0x92;
constexpr uint8_t OP_MULTIPACKETANSWER = 0x93;
...
constexpr uint8_t OP_MULTIPACKET_EXT = 0xa4;
constexpr uint8_t OP_SENDINGPART_I64 = 0xa2;
constexpr uint8_t OP_CALLBACK = 0x99;
...
constexpr uint8_t OP_DIRECTCALLBACKREQ = 0x95;
...
constexpr uint8_t KAD_CALLBACK_REQ = 0x52;
